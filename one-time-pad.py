...
Programa para simular una comunicación encriptada por el método one time pad, que acepta cadenas de catacteres menores a 27, sin espacios.
...
#Código abstraido del encontrado en usuario albohlabs https://github.com/albohlabs/one-time-pad
